 ...
 */
public class NetworkInterpolatedTransform : MonoBehaviourPunCallbacks
{
    ...
    void Update()
    {
        ...
        transform.position = Vector3.Lerp(olderTransform, newestTransform, NetworkInterpolationController.InterpolationFactor);
    }
